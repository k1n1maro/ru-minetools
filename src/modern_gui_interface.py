    ...
    def create_settings_page(self):
        ...
        try:
            ...
            if CURRENT_VERSION == "1.0.0":
                new_features_label = QLabel("�  Первый стабильный релиз RU-MINETOOLS!")
...
Способы поддержки:""")
    ...
    def show_beta_warning_dialog(self):
        ...
        try:
            from update_config import CURRENT_VERSION
            if CURRENT_VERSION == "1.0.0":
                version_info = """<p style="font-size: 14px; color: #10b981;"><b>� Верссия 1.0.0:</b> Первый стабильный релиз! Переводите FTB квесты и JAR моды на русский язык с умной терминологией и автообновлениями.</p>"""
            elif CURRENT_VERSION == "1.2.0":
